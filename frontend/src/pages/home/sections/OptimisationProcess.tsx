...
const steps = [
  {
    ...
    description: 'Drop in your existing resume — PDF, DOC, or DOCX. Our parser instantly reads every section: experience, skills, education, and more.',
  ...
  },
  {
    ...
    description: 'Paste the full JD or drop in a job post URL from LinkedIn, Indeed, or any job board. Our AI extracts every requirement and keyword.',
  ...
  },
  {
    ...
    description: 'Our engine compares your resume against the JD — identifying missing keywords, weak bullet points, and formatting issues that ATS systems flag.',
  ...
  },
  {
    number: '04',
    icon: 'ri-edit-2-line',
    title: 'Rewrites & Injects Keywords',
    description: 'Bullet points are rewritten with strong action verbs. Missing JD keywords are woven in naturally — no stuffing, just smart, readable copy.',
  ...
  },
  {
    ...
    description: 'We verify fonts, section headers, file structure, and layout against 50+ ATS systems — ensuring your resume is never auto-rejected on a technicality.',
  ...
  },
  {
    ...
    description: 'Get your polished, ATS-optimised resume with a full score report. Download it instantly and start applying with confidence.',
      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 xl:px-12 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 lg:mb-20">
          ...
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-5 tracking-tight leading-[1.1]">
            From Upload to
            <span className="bg-gradient-to-r from-teal-600 to-emerald-500 bg-clip-text text-transparent"> 94% ATS Match</span>
          </h2>
          <p className="text-xl text-gray-600 leading-relaxed">
            Six precise steps — powered by AI — that transform a generic resume into a tailored, keyword-rich document that gets past every filter.
          </p>
        </div>
        ...
        <div className="text-center mt-10">
          ...
          >
            ...
            Try It Free — Optimise Your Resume
            <i className="ri-arrow-right-line"></i>
          </Link>
          <p className="text-sm text-gray-500 mt-3">No sign-up required to try · Results in under 60 seconds</p>
        </div>
