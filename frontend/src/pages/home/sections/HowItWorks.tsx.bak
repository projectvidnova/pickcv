...
const steps = [
  {
    ...
    title: 'Create Resume',
    description: 'Simply write a prompt describing your experience. Our AI instantly formats it into a professional, ATS-optimized resume tailored to your industry.',
  ...
  },
  {
    ...
    description: 'Our AI analyzes your profile and matches you with relevant job opportunities from thousands of listings based on your skills and preferences.',
  ...
  },
  {
    ...
    description: 'Automatically customize your resume for every job application. The AI highlights your most relevant experience to maximize your chances.',
  ...
  },
  {
    ...
    title: 'Improve Skills & Apply',
    description: 'Get personalized course suggestions to fill skill gaps. Then apply with confidence using our application tracker to manage your job search.',
      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 xl:px-12 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 lg:mb-16">
          ...
          <p className="text-xl text-gray-600 leading-relaxed">
            From prompt to job offer in four simple steps
          </p>
        </div>

        {/* Steps Grid */}
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 max-w-7xl mx-auto perspective-1000">
          {steps.map((step, index) => (
            ...
            >
              {index < steps.length - 1 && (
                <div className="hidden lg:block absolute top-32 left-full w-8 h-0.5 bg-gradient-to-r from-teal-300/50 to-transparent z-0">
                  <div className="absolute right-0 top-1/2 -translate-y-1/2">
                    <i className="ri-arrow-right-s-line text-2xl text-teal-300"></i>
                  </div>
                </div>
              )}
              ...
              >
                ...
                <div className="mb-6 mt-4 relative h-40 flex items-center justify-center">
                  {step.illustration === 'document' && (
                    <div className="relative w-28 h-36 transition-transform duration-500"
                      style={{ transform: hoveredStep === index ? 'translateZ(30px) rotateY(10deg)' : 'translateZ(0) rotateY(0)' }}>
                      <div className="absolute inset-0 rounded-2xl shadow-2xl p-3 glass">
                        <div className="space-y-2">
                          <div className="h-2 bg-white/60 rounded-full w-3/4"></div>
                          <div className="h-2 bg-white/60 rounded-full w-full"></div>
                          <div className="h-2 bg-teal-200/80 rounded-full w-2/3"></div>
                          <div className="h-2 bg-white/60 rounded-full w-5/6"></div>
                        </div>
                      </div>
                      <div className="absolute -right-3 -top-3 w-10 h-10 bg-gradient-to-br from-teal-500 to-teal-600 rounded-xl flex items-center justify-center text-white shadow-xl"
                        style={{ transform: hoveredStep === index ? 'translateZ(40px) rotate(-15deg)' : 'translateZ(0) rotate(0)', transition: 'transform 0.5s ease' }}>
                  ...
                  {step.illustration === 'target' && (
                    <div className="relative w-36 h-36 transition-transform duration-500"
                      ...
                      <div className="absolute inset-3 rounded-full border-4 border-green-300/60"></div>
                      <div className="absolute inset-6 rounded-full border-4 border-green-400/60"></div>
                      <div className="absolute inset-10 rounded-full bg-gradient-to-br from-green-500 to-emerald-600 shadow-2xl flex items-center justify-center">
                        <i className="ri-focus-2-line text-3xl text-white"></i>
                      </div>
                  ...
                  {step.illustration === 'course' && (
                    <div className="relative w-36 h-36 transition-transform duration-500"
                      ...
                      <div className="absolute inset-0 bg-gradient-to-br from-amber-500 to-orange-600 rounded-full shadow-2xl flex items-center justify-center">
                      ...
                      <div className="absolute -right-2 top-1/3 w-10 h-10 rounded-xl shadow-xl flex items-center justify-center glass"
                        ...
                        <i className="ri-bar-chart-line text-amber-500 text-xl"></i>
                      </div>
                    </div>
                  )}
                </div>
