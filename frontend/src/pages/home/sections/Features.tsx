...
const features = [
  {
    ...
    description: 'Real-time scoring against applicant tracking systems used by 98% of Fortune 500 companies. Ensure your resume never gets auto-rejected.',
  ...
  },
  {
    ...
    description: 'See exactly how prepared you are for your target role with comprehensive gap analysis. Know where you stand before recruiters do.',
  ...
  },
  {
    ...
    title: 'Skill Extraction & Scoring',
    description: 'AI identifies and highlights both hard and soft skills from your experience. Get a prioritized list of improvements with actionable score breakdown.',
  ...
  },
  {
    ...
    description: 'AI-powered job recommendations based on your skills, experience, and preferences. Track applications, interviews, and follow-ups all in one place.',
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto perspective-1000">
          ...
          >
            ...
            <div className="space-y-2">
              {[
                { title: 'Frontend Developer', match: 94, color: 'bg-green-500' },
                { title: 'Full Stack Engineer', match: 88, color: 'bg-green-400' },
                { title: 'React Developer', match: 82, color: 'bg-cyan-400' },
              ].map((job, idx) => (
          ...
          >
            ...
            <div className="space-y-3">
              {[
                { skill: 'ATS Keywords', level: 45, needed: 90, color: 'bg-amber-500' },
                { skill: 'Action Verbs', level: 60, needed: 85, color: 'bg-orange-500' },
              ].map((item, idx) => (
                <div key={idx}>
