      ...
      <nav className="border-b border-gray-800 bg-gray-900/80 backdrop-blur-xl sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            ...
            <Link to="/jobs" className="text-white text-sm font-medium">Jobs</Link>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        {loading ? (
          ...
          <div className="text-center py-20 bg-gray-800/30 rounded-2xl border border-gray-700/50">
            <i className="ri-error-warning-line text-red-400 text-4xl mb-3" />
            <p className="text-red-300 mb-4">{error}</p>
            <button onClick={loadJobs} className="px-5 py-2.5 bg-blue-500 text-white text-sm rounded-xl hover:bg-blue-600">
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      <Link to={`/jobs/${job.id}`} className="text-lg font-semibold text-white hover:text-blue-400 transition-colors">
                        {job.title}
                      </Link>
                    ...
                    <div className="flex items-center gap-6 mt-3 text-sm">
                      <Link to={`/jobs/${job.id}`} className="text-blue-400 hover:text-blue-300">
