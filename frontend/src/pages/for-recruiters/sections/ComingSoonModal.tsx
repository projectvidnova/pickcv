...
export default function ComingSoonModal({ isOpen, action, onClose }: ComingSoonModalProps) {
  ...
  const title = action === 'register' ? 'Company Registration Is Launching Soon' : 'Recruiter Sign In Is Launching Soon';
  const subtitle = action === 'register'
    ? 'We are finalizing recruiter onboarding, company verification, and team setup.'
    : 'We are polishing recruiter sign in, workspace setup, and hiring dashboards.';
      ...
      <div className="relative w-full max-w-lg glass-card rounded-3xl border border-white/60 p-7 sm:p-8 shadow-2xl">
        ...
        <div className="rounded-2xl border border-teal-100 bg-gradient-to-r from-teal-50 to-emerald-50 p-4 mb-6">
          ...
          <p className="text-sm text-gray-600">
            PickCV for recruiters is in final testing. You will get the same AI-first experience as the rest of the platform.
          </p>
        </div>
