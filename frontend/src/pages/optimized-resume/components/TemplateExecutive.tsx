  ...
  return (
    <div className="bg-white font-sans text-gray-900 min-h-[1000px]">
      ...
      <div className="bg-gray-900 text-white px-10 py-8">
        <h2 className="text-4xl font-black tracking-tight mb-1">{data.name}</h2>
        <p className="text-teal-400 font-semibold text-base tracking-wide mb-4">{data.title}</p>
      ...
      <div className="p-10">
        {/* Summary with accent */}
        <div className="mb-8 p-5 bg-teal-50 border-l-4 border-teal-500 rounded-r-lg">
        ...
        <div className="mb-8">
          ...
          <div className="flex flex-wrap gap-2">
            {data.skills.map((skill, i) => (
              <span key={i} className="px-3 py-1 bg-gray-900 text-white text-xs font-semibold rounded">
                {skill}
              </span>
            ))}
          </div>
