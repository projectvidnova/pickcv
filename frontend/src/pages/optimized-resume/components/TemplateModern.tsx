...
export default function TemplateModern({ data }: Props) {
  return (
    <div className="w-full bg-white font-sans text-gray-900 flex leading-[1.35]">
      {/* Left Sidebar */}
      <div className="w-56 flex-shrink-0 bg-gradient-to-b from-teal-700 to-teal-900 text-white p-5 flex flex-col gap-5">
        {/* Avatar / Initials */}
        <div className="text-center">
          <div className="w-16 h-16 rounded-full bg-white/20 border-2 border-white/40 flex items-center justify-center mx-auto mb-2.5">
