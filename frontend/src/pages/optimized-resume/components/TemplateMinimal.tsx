...
export default function TemplateMinimal({ data }: Props) {
  return (
    <div className="bg-white font-sans text-gray-900 p-10 min-h-[1000px]">
      {/* Header - ultra clean */}
      <div className="mb-8">
        <h2 className="text-4xl font-light tracking-tight text-gray-900 mb-1">{data.name}</h2>
        <p className="text-base text-gray-400 font-light mb-4">{data.title}</p>
